...
const TransporterListTable = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.post(`${dev}/transporter/getTransporter`, {
                    headers: {
    ...
    const handleEditClick = (TransporterNameId) => {
        navigate("/addtransporter", { state: { TransporterNameId, Type: "" } });
    };
        ...
        return (
            <React.Fragment>
                <div style={{ display: 'flex' }}>
                    {/* <Button icon="pi pi-pencil" className="p-button-rounded p-button-success" data-pr-tooltip="Edit Transporter" style={{ marginRight: '5px' }} onClick={() => handleEditClick(rowData.TransporterNameId)} /> */}
                    <Button  icon="pi pi-pencil" className="p-button p-button-success p-button-icon-only custom-tooltip-button"   data-pr-tooltip="Edit New Transporter"
                        ...
                        onClick={() => handleEditClick(rowData.TransporterNameId)}
                    />
            ...
            <div className="container" style={{width:'100%', padding: '10px' }}  >
                <div className="row align-items-center" style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                    ...
                    <div className="col-md-5" style={{ display: 'flex', width:'100%', justifyContent: 'flex-end', alignItems: 'center' }}>
                        <Link to="/addtransporter" className="plus" data-pr-tooltip="Add New Transporter" style={{ marginRight: '10px' }}>
                        ...
                        <Tooltip target=".plus" content="Add New Transporter"  position="top" className="custom-tooltip"  />
    ...
    const exportExcel = async () => {
        ...
        link.download = 'TransporterList.xlsx';
        link.click();
    ...
    return (
        <div className="datatable-filter-demo">
            <div className="card">
                ...
                >
                    <Column style={{ border: "0.5px dotted black" }} field="TransporterName" header="Transporter Name"  sortable />
                    <Column style={{ border: "0.5px dotted black" }} field="MobileNumber" header="Mobile Number" sortable />
                    <Column style={{ border: "0.5px dotted black" }} field="Email" header="Email"  sortable />
                    <Column style={{ border: "0.5px dotted black" }} field="Country" header="Country" sortable />
                    <Column style={{ border: "0.5px dotted black" }} field="State" header="State" sortable />
