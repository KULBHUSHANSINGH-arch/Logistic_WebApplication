...
// export const TransporterColumn = () => {
//   return (
//     <div>
...
export const TransporterColumn = (data, formData, handleOpen) => {
  ...
  const columns = [
    {
      ...
      renderCell: (params) => {
        ...
        const getRankDetails = (index) => {
          if (index === 0) return { image: rank1, size: 40, bgColor: "red" }; // Darker green
          if (index === 1) return { image: rank2, size: 35, bgColor: "orange" }; // Medium green
        ...
        return (
          <Box
            ...
            sx={{
              ...
              backgroundColor: data?.length > 1 ? getRankDetails(rowIndex).bgColor :   'transparent', // Dynamic background color
              padding: "4px 8px",
              borderRadius: "4px", // Optional corner rounding
              cursor: "pointer", // Cursor pointer when hovering over the row
            }}
          >
            {data?.length > 1 && getRankDetails(rowIndex).image && (
              <img
                src={getRankDetails(rowIndex).image}
                alt={`Rank ${rowIndex + 1}`}
                style={{
                  width: getRankDetails(rowIndex).size,
                  height: getRankDetails(rowIndex).size,
    ...
    {
      field: "totalVehicles",
      headerName: "Total No Of Vechiles",
      minWidth: 120,
      flex: 1,
      sortable: true,
      ...
      renderCell: (params) => {
        ...
        const getBackgroundColor = (index) => {
          if (index === 0) return "red"; // Darker green
          if (index === 1) return "orange"; // Medium green
