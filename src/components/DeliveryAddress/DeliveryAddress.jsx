...
function DeliveryAddress() {
  ...
  const handleChange = (e) => {
    ...
    // GST validation for real-time error display
    if (name === "GSTNo") {
      const gstError = validateGST(value);
      setErrors((prevErrors) => ({
        ...prevErrors,
        GSTNo: gstError ? gstError : "", // If there's an error, set it, otherwise clear it
      }));
    }
  };
      ...
      <div className="bg-[#fff] p-4 md:p-3 shadow-lg rounded-lg w-full max-w-4xl mx-auto">
        <div className="mb-4 md:mb-6 flex flex-col items-center">
          <h1 className="text-[#2c3e50] text-3xl md:text-2xl font-extrabold font-serif">
            {deliveryId ? "Edit Delivery" : "Delivery Address"}
          </h1>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="col-span-2 min-w-[250px]">
              ...
              <input
                ...
                className={`w-full p-2 border ${
                  errors.ShipmentName ? "border-red-500" : "border-gray-300"
                } rounded-md focus:ring-2 focus:ring-blue-400 focus:outline-none`}
              />
              {errors.ShipmentName && (
